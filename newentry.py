...
class NewEntryWindow(gtk.Window):
    def __init__(self, database : Database):
        ...
        self.grid.attach(self.scrollable_treelist, 1, 5, 3, 1)
        ...
        self.grid.attach(self.button_save, 1, 7, 1, 1)
        self.grid.attach(self.button_cancel, 2, 7, 1, 1)
    ...
    def do_save_entry(self, source, callback_data = None):
        ...
        item = Database.Item(text=title, action=action_text, type=action_type)
